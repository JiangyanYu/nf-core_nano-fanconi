...
*/
    ...
    if (params.run_whatshap) {
        ...
        //
        ch_whatshap_input = MERGE_BASECALL_SAMPLE.out.bam.mix(SAMTOOLS_SORT.out.bai,SNIFFLES_SORT_VCF.out.vcf).groupTuple(size:3).map{ meta, files -> [ meta, files.flatten() ]}
